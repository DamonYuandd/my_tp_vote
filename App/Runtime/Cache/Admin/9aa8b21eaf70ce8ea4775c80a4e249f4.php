...
<script>setInterval(function(){location.href="<?php echo $jumpUrl; ?>";},3000);</script>
<style>
...
<div class="message">
	<div class="msg">
	<?php if(isset($message)): ?><span class="success"><?php echo constant("$msgTitle*");?><?php echo ($message); ?></span>
	<?php else: ?>
	<span class="error"><?php echo constant("$msgTitle*");?><?php echo ($error); ?></span><?php endif; ?>
	</div>
	<div class="tip">
	<?php if(isset($closeWin)): ?>页面将在 <span class="wait"><?php echo ($waitSecond); ?></span> 秒后自动关闭，如果不想等待请点击 <a href="<?php echo ($jumpUrl); ?>">这里</a> 关闭
	<?php else: ?>
		页面将在 <span class="wait"><?php echo ($waitSecond); ?></span> 秒后自动跳转，如果不想等待请点击 <a href="<?php echo ($jumpUrl); ?>">这里</a> 返回<?php endif; ?>
	</div>
</div>
</body>
</html>