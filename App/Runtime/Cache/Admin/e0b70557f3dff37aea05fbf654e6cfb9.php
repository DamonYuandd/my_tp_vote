...
<form action="__APP__/Admin/Link" method="post" id="form_list">
		...
		<tr>
			<th width="600">
				<div class="qw-fl grid-add-data">
					<input type="button" value="添加链接" class="button-img-add"  onclick="goToUrl('__APP__/Admin/Link/edit/lang/<?php echo $_GET["lang"];?>/cid/<?php echo $_GET["cid"];?>')"/>
				</div>
...
<table class="grid-table" border="1" cellpadding="0" cellspacing="0"> 
	...
	<?php if(!empty($dataList)): ?><tbody>
		<?php if(is_array($dataList)): $i = 0; $__LIST__ = $dataList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr> 
		    ...
		    <td><?php getLangTextTitle($vo['lang']);?><a href="__APP__/Admin/Link/edit/id/<?php echo ($vo["id"]); ?>/lang/<?php echo ($vo["lang"]); ?>/cid/<?php echo $_GET["cid"];?>" ><?php echo ($vo["title"]); ?></a>
		    ...
		    <td><a href="__APP__/Admin/Link/edit/id/<?php echo ($vo["id"]); ?>/lang/<?php echo ($vo["lang"]); ?>/cid/<?php echo $_GET["cid"];?>"><img src="__ADMIN__/Public/imgs/edit.png" /></a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="javascript:deleteData('__APP__/Admin/Link/deleteById/id/<?php echo ($vo["id"]); ?>');"><img src="__ADMIN__/Public/imgs/cross.png" /></a></td>
		</tr><?php endforeach; endif; else: echo "" ;endif; ?>
	</tbody>
	<?php else: ?>
	<tbody>
		<tr>
			<td colspan="11" align="center" style="color:red;">没有找到数据！！！<a href="__APP__/Admin/Link/edit/cid/<?php echo $_GET["cid"];?>">添加</a></td>
		</tr>
	</tbody><?php endif; ?>
	<tfoot>
		<tr>
